...
export const discoverUsers = async (req,res) =>{
  ...
  const filteredUsers = allUsers.filter(user=> user._id!==userId);
     res.join({success:true,users:filteredUsers});
  } catch (error) {
    console.log(error);
...
export const followUser = async (req,res) =>{
  try {
    ...
    if(user.following.includes(id)){
      return res.join({success:false,message:'You are already following this user'})
    }
    ...
    res.join({success:false,message:'Now you are following this user'})
